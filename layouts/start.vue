...
<script>
import peter from "./footer_mdide.vue";
console.log(peter);
debugger
</script>
<!-- default.vue -->
<template>
  <div class="slidev-layout default cover center">
    ...
    <div class="footer-waves">
     <svg class="fusion-hills-opacity-candy" fill="var(--awb-custom_color_2)" xmlns="http://www.w3.org/2000/svg" version="1.1" width="100%" viewBox="0 -0.5 1024 182" preserveAspectRatio="none"><path class="st0" d="M0 182.086h1024V41.593c-28.058-21.504-60.109-37.581-97.075-37.581-112.845 0-198.144 93.798-289.792 93.798S437.658 6.777 351.846 6.777s-142.234 82.125-238.49 82.125c-63.078 0-75.776-31.744-113.357-53.658L0 182.086z"></path>
